...
- Global and account-owned exercise libraries with progress insights/history clearing, manual templates/programs with targeted muscle tags and responsive set prescription editing, standalone and program swap restore to default baselines, multi-phase scheduling, and AI PDF extraction with background progress, technique-aware catalog matching, explicit rep bounds, selectable 6–10 RPE, averaged rest ranges, standardized responsive set editing, swipe-to-delete on compact layouts, and searchable editable review with default draft/exercise restore that blocks program creation until mappings and issues are resolved.
