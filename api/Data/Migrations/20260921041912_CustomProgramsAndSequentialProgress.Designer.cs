...
namespace Workout.Api.Data.Migrations
{
    ...
    [Migration("20260921041912_CustomProgramsAndSequentialProgress")]
    partial class CustomProgramsAndSequentialProgress
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Workout.Api.Data.ProgramDraft", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("CreatedProgramId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserId", "CreatedProgramId")
                        .IsUnique()
                        .HasFilter("\"CreatedProgramId\" IS NOT NULL");

                    b.HasIndex("UserId", "RequestKey")
                        .IsUnique()
                        .HasFilter("\"RequestKey\" IS NOT NULL");

                    b.HasIndex("UserId", "Updated");

                    b.ToTable("ProgramDrafts");
                });
