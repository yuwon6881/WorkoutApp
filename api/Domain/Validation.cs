...
public static class Validation
{
    ...
    /// may be blank while the set is still being typed, but completing it requires both.
    public static void LoggedSet(double? weightKg, int? reps, double? rpe, bool done)
    {
        ...
        if (done) Require(reps != null && rpe != null, "A completed set needs its reps and RPE.");
    }
