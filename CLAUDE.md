...
- Global and account-owned exercise libraries with progress insights/history clearing, manual templates/programs with targeted muscle tags, partner-selection superset pairing, and responsive set prescription editing, standalone and program swap restore to default baselines with catalog-backed substitutions, multi-phase scheduling, and AI PDF extraction with coordinate column preservation, background progress, technique-aware catalog matching, superset detection and pairing, dual working sets with RIR-to-RPE conversion, explicit rep bounds, selectable 6–10 RPE, averaged rest ranges, standardized responsive set editing, exercise removal with superset repair, swipe-to-delete on compact layouts, and uplifted searchable editable review with add/delete week management, non-blocking informational notices, and default draft/exercise restore with local busy states that blocks program creation until mappings and blocking issues are resolved.
