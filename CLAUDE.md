...
- Global and account-owned exercise libraries with primary and secondary muscle metadata, ranked catalog alternatives, progress insights/history clearing, manual templates/programs with targeted muscle tags, partner-selection superset pairing, and responsive set prescription editing, standalone and program swap restore to default baselines with catalog-backed substitutions, multi-phase ordered progression without calendar delays, and AI PDF extraction with header-aligned multi-layout table reconstruction, source-validated outline and block/phase reconciliation, one-to-one source-row recovery of fused names and prescriptions, background progress and cancellation, technique-aware catalog matching, superset detection and pairing, dual working sets with RIR-to-RPE conversion, explicit and compound rep prescriptions, preserved %1RM source loads, selectable 6–10 RPE, averaged rest ranges, standardized responsive set editing, named alternative-program selection, 7-day week reconciliation with trailing rest trimming and overflow detection, exercise removal with superset repair, swipe-to-delete on compact layouts, and uplifted searchable editable review with add/delete week management, non-blocking informational notices, revision-checked queued saves, grouped slot mapping, and default draft/exercise restore with local busy states that blocks program creation until mappings and blocking issues are resolved.
